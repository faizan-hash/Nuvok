    ...
    >
        @if ($showType !== 'button')
            <div
                ...
                >
                    <span class="ms-auto font-medium">
                        @formatNumberShort($invoiceCreditsCount)
                    </span>
                </x-legend>
                ...
                >
                    <span class="ms-auto font-medium">
                        @formatNumberShort($clientCreditsCount)
                    </span>
                </x-legend>
                ...
                >
                    <span class="ms-auto font-medium">
                        @formatNumberShort($projectCreditsCount)
                    </span>
                </x-legend>
                ...
                >
                    <span class="ms-auto font-medium">
                        @formatNumberShort($businessCredits->tasks ?? 0)
                    </span>
                </x-legend>
            </div>
