            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/crm.jpg')}}" alt="CRM Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/contractor-phone.jpg')}}" alt="Contractor using phone for invoicing" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center gap-2">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #6EE7B7; color: #1C2A39;">Pro</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/finance.jpg')}}" alt="Bookkeeping Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/proposal.jpg')}}" alt="Proposal Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center gap-2">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #6EE7B7; color: #1C2A39;">Pro</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/clientportal.jpg')}}" alt="Client Portal Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center gap-2">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #6EE7B7; color: #1C2A39;">Pro</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/projectmanagement.jpg')}}" alt="Kanban Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #B06F49; color: #F9FAFB;">Enterprise</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/contractor-form.jpg')}}" alt="Contractor writing on form" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #B06F49; color: #F9FAFB;">Enterprise</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        ...
                        <img src="{{asset('businesstoolsImages/zapier.jpg')}}" alt="Zapier Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        <i class="fas fa-file-invoice-dollar text-4xl mb-4" style="color: #6EE7B7;"></i>
                        <h3 class="text-xl font-semibold mb-2" style="color: #1C2A39;">Invoicing</h3>
                        <p class="mb-4" style="color: #1C2A39;">Create and send professional invoices, track payments, and automate reminders.</p>
                        <img src="{{asset('businesstoolsImages/invoice.jpg')}}" alt="Invoicing Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center gap-2">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #6EE7B7; color: #1C2A39;">Pro</span>
                ...
                <div class="rounded-lg shadow-lg p-6 text-center flex flex-col h-full" style="background-color: #F9FAFB;">
                    <div class="flex-grow">
                        <i class="fas fa-robot text-4xl mb-4" style="color: #6EE7B7;"></i>
                        <h3 class="text-xl font-semibold mb-2" style="color: #1C2A39;">AI Quote Generator <span class="text-sm" style="color: #1C2A39;">(Coming Soon)</span></h3>
                        <p class="mb-4" style="color: #1C2A39;">Generate accurate quotes instantly with AI-powered automation.</p>
                        <img src="{{asset('businesstoolsImages/ai.jpg')}}" alt="AI Quote Generator Screenshot" class="w-full h-32 object-cover rounded-md mb-4">
                    </div>
                    <div class="mt-auto pt-4">
                        <div class="flex justify-center">
                            <span class="inline-block text-sm font-medium px-3 py-1 rounded" style="background-color: #B06F49; color: #F9FAFB;">Enterprise</span>
