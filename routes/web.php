...
Route::get('/install', [InstallationController::class, 'install']);
...
Route::middleware(['auth'])->prefix('dashboard/business')->name('dashboard.business.')->group(function () {
    Route::get('contact-history', [\App\Http\Controllers\Business\ContactHistoryController::class, 'index'])->name('contact-history.index');
});
Route::middleware(['auth'])->prefix('dashboard/business')->name('dashboard.business.')->group(function () {
    Route::get('dashboard.user.openai.estimator', [\App\Http\Controllers\Business\AiEstimatorController::class, 'index'])->name('dashboard.user.openai.estimator');
    Route::get('AiEstimator', [\App\Http\Controllers\Business\AiEstimatorController::class, 'index'])->name('AiEstimator.index');
