    ...
    public function data(): array
    {
      ...
      'business_label' => [
            ...
            'clients' => [
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.clients.*'],
            ],
            'task' => [
                'parent_key'       => null,
                'key'              => 'task',
                'route'            => 'dashboard.business.task.index',
                'label'            => 'Tasks',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.task.*'],
            ],
            'projects' => [
                'parent_key'       => null,
                'key'              => 'projects',
                'route'            => 'dashboard.business.projects.index',
                'label'            => 'Projects',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.projects.*'],
            ],
            'taxes' => [
                'parent_key'       => null,
                'key'              => 'taxes',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.taxes.*'],
            ],
            'invoices' => [
                'parent_key'       => null,
                'key'              => 'invoices',
                'route'            => 'dashboard.business.invoices.index',
                'label'            => 'Invoices',
                'icon'             => 'tabler-file-invoice',
                'svg'              => null,
                'order'            => 95,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.invoices.*'],
            ],
            'calendly' => [
                'parent_key'       => null,
                'key'              => 'calendly',
                'route'            => 'dashboard.business.calendly.index',
                'label'            => 'calendly',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.calendly.*'],
            ],
            'calender' => [
                'parent_key'       => null,
                'key'              => 'calender',
                'route'            => 'dashboard.business.calender.index',
                'label'            => 'calender',
                'icon'             => 'tabler-calendar-event',
                'svg'              => null,
                'order'            => 97,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.calender.*'],
            ],
            'analytics' => [
                'parent_key'       => null,
                'key'              => 'analytics',
                'route'            => 'dashboard.business.analytics.index',
                'label'            => 'Analytics',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.analytics.*'],
            ],
            'contact_history' => [
                'parent_key'       => 'null',
                'key'              => 'contact_history',
                'route'            => 'dashboard.business.contact-history.index',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.business.contact-history.*'],
            ],
            'user_label' => [
                'parent_key'       => null,
                'key'              => 'user_label',
