...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        //  dd($templates,$plansPrepaid,$plansSubscription,$filters,$tools,$testimonials,$howitWorks,$howitWorksDefaults,$clients,$futures,$who_is_for,$generatorsList,$plansSubscriptionMonthly,$plansSubscriptionLifetime);
