...
class Plan extends Model
{
    ...
    protected $fillable = [
        ...
        'max_subscribe',
        'last_date',
        'business_invoices_limit',
        'business_clients_limit',
        'business_projects_limit',
    ...
    {
        // Return specific feature counts based on plan price tiers
        if ($this->price >= 50 && $this->price < 100) {
            // Business tier (50-99) - 196 features
            return 196;
        } elseif ($this->price > 0 && $this->price < 50) {
            // Starter tier (1-49) - 238 features
            return 238;
        } else {
            // All other plans (Free, Premium, Enterprise) - 239 features
            return 239;
        }
    }
    ...
    public function getBusinessCreditsByPrice(): array
    {
        // Base credits for starter plans
        $baseCredits = [
            'invoices' => 2,
            'clients' => 2,
            'projects' => 2,
        ...
        // Scale credits based on price tiers
        if ($this->price >= 100) {
            // Enterprise tier (100+)
            return [
                'invoices' => 50,
    ...
    private static function getFreshData(): array
    {
        return [
            ...
            'max_subscribe'        => 0,
            'last_date'            => null,
            'business_invoices_limit' => 2,
            'business_clients_limit' => 2,
            'business_projects_limit' => 2,
            'business_tasks_limit' => 2,
        ];
    }
