...
<style>
    ...
    .lqd-navbar > * {
    display: inline-block; /* har child element ko horizontal line me lana ke liye */
    vertical-align: top;
}
.lqd-navbar-inner{
    width: 220px;
...
<!--<script>-->
<!--    toastr.options = {-->
        <!--"positionClass": "toast-bottom-right", // 👈 change this-->
        <!--// "timeOut": "3",-->
<!--        "closeButton": true,-->
<!--        "progressBar": true,-->
<!--    };-->
...
<?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/panel/layout/app.blade.php ENDPATH**/ ?>