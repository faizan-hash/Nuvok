    ...
    >
        <div class="container">
            ...
            >
                ...
                <div class="mb-20 grid grid-cols-3 gap-7 max-md:grid-cols-1">
                    <div style="color:white;" class="group mx-auto flex max-w-[270px] flex-col items-center text-center text-[18px] font-medium">
                    ...
                    <div style="color:white;" class="group mx-auto flex max-w-[270px] flex-col items-center text-center text-[18px] font-medium">
                        ...
                        <p><strong>We draft the content for you</strong><br>NuvokAI instantly generates quotes, follow-ups, or proposals based on your input.</p>
                    </div>
                    <div style="color:white;" class="group mx-auto flex max-w-[270px] flex-col items-center text-center text-[18px] font-medium">
                ...
                <div class="flex justify-center mt-8">
                    <a href="#" class="bg-[#6EE7B7] text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg hover:bg-[#B06F49] hover:text-white transition">Try NuvokAI Free – No Card Needed</a>
                </div>
            </div>
        </div>
    </section>
<?php /**PATH /var/www/Novuk/resources/views/default/landing-page/how-it-works/section.blade.php ENDPATH**/ ?>