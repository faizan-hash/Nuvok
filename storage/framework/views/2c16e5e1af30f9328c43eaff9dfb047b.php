...
<?php endif; ?>
    ...
    <?php endif; ?>
    <form class="flex flex-col gap-6" novalidate="novalidate" onsubmit="event.preventDefault(); return LoginForm();">
...
<?php endif; ?>
    ...
    <?php if($setting->register_active == 1): ?>
        <div class="mt-20">
            ...
            <a class="font-medium text-indigo-600 underline" href="<?php echo e(route('register')); ?>">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        console.log('Initial page load URL:', window.location.href);
        ...
        history.pushState = function(...args) {
            ...
            console.log('Current URL before pushState:', window.location.href);
        ...
        window.addEventListener('hashchange', function(event) {
            ...
            console.log('URL after hashchange:', window.location.href);
        });
        ...
        window.addEventListener('load', function() {
            console.log('Window loaded, URL:', window.location.href);
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.authentication.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\DELL\Desktop\Novuk\resources\views/default/panel/authentication/login.blade.php ENDPATH**/ ?>