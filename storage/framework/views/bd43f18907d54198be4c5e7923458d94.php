...
<?php $component = App\View\Components\SectionHeader::resolve(['mb' => '7','width' => 'w-3/5','title' => 'Custom Templates','subtitle' => ''.$fSectSettings->custom_templates_description ??
...
<?php endif; ?>
    ...
    <button id="templates-show-more-btn" class="templates-toggle-btn text-[14px] font-semibold text-[#5A4791]">
    ...
    <button id="templates-show-less-btn" class="templates-toggle-btn hidden text-[14px] font-semibold text-[#5A4791]">
        <span class="size-7 mr-1 inline-grid place-content-center rounded-lg bg-[#885EFE] bg-opacity-10">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.998 7.125V5.671H11.798V7.125H0.998Z" />
            </svg>
        </span>
        <span class="inline-grid h-7 place-content-center rounded-lg bg-[#885EFE] bg-opacity-10 px-2">
            <?php echo e(__('Show less')); ?>
...
<?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/landing-page/custom-templates/section.blade.php ENDPATH**/ ?>