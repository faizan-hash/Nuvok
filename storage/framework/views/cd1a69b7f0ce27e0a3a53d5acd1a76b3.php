...
<?php $component = App\View\Components\SectionHeader::resolve(['mb' => '9','width' => 'w-1/2','title' => 'Have a Question?','subtitle' => ''.__($fSectSettings->faq_subtitle).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <div class="lqd-accordion mx-auto w-5/6 max-lg:w-full">
               <?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php echo $__env->make('landing-page.faq.item', [
                      'id' => 'faq-' . $item->id,
                      'title' => $item->question,
                      'content' => $item->answer,
...
</section><?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/landing-page/faq/section.blade.php ENDPATH**/ ?>