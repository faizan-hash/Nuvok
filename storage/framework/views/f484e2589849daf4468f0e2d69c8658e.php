        ...
        <div class="container">
            ...
            >
                <div class="mx-auto mb-14 w-2/5 text-center max-xl:w-1/2 max-lg:w-8/12 max-md:w-full">
                    <!--<?php echo __($fSectSettings->how_it_works_title); ?>-->
                ...
                <?php if($howitWorksDefaults['option'] == 1): ?>
                    <div style="color:white;" class="flex justify-center text-[#A2B2C9]">
                       Want to see?Join Nuvok
                    </div>
                <?php endif; ?>
            </div>
        </div>
    </section>
<?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/landing-page/how-it-works/section.blade.php ENDPATH**/ ?>