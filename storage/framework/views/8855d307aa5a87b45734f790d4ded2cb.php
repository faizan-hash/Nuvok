...
switch ($style) {
    ...
    case '2':
        ...
        break;
   case '3':
    $wrapper_classname .= 'px-4 pb-6 bg-[#F5F5F7] rounded-2xl text-center overflow-hidden transition-all hover:-translate-y-1 hover:shadow-md';
    $title_classname .= 'font-bold text-sm'; // optional: make text smaller
    break;
...
<div class="<?php echo e($wrapper_classname); ?>" style="height: 250px;">
    <?php if(!empty($icon)): ?>
...
<?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/components/box.blade.php ENDPATH**/ ?>