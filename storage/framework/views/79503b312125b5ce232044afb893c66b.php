...
.lqd-accordion-content {
    /* Reset any problematic whitespace handling */
    white-space: normal !important;
}
.lqd-accordion-content table {
    width: 100%;
    border-collapse: collapse;
    margin: 1rem 0;
}
.lqd-accordion-content th, 
.lqd-accordion-content td {
    padding: 8px 12px;
...
<div class="lqd-accordion-item group">
	...
	<div id=<?php echo e($id); ?> class="hidden">
		<div class="py-4 pl-3 lqd-accordion-content">
			<p class="text-lg max-sm:text-[17px] whitespace-pre-line"><?php echo $content; ?></p>
		</div>
	</div>
</div><?php /**PATH /home/u832531023/domains/nuvokai.com/public_html/resources/views/default/components/accordion-item.blade.php ENDPATH**/ ?>