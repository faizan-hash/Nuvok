<?php $__env->startSection('title', __('OTP Verify')); ?>
            ...
            <div class="w-full max-w-6xl mx-auto px-4 md:px-6">
                <div class="flex justify-center">
                    <div class="max-w-md mx-auto text-center bg-white px-4 sm:px-8 py-10 rounded-xl shadow">
                        <header class="mb-8">
                            <h1 class="text-2xl font-bold mb-3"><?php echo e(__("Email Verification")); ?></h1>
                            <p class="text-[15px] text-gray-700"><?php echo e(__("Enter the 4-digit verification code that was sent to your email.")); ?></p>
                        </header>
                        <div id="error-container" class="mb-4 text-red-500"></div>
                        <form id="otp-form" method="POST" action="<?php echo e(route('verify-otp')); ?>">
                            <?php echo csrf_field(); ?>
        ...
        form.addEventListener('submit', function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    toastr.success('<?php echo e(__("Verification successful, redirecting...")); ?>');
                ...
                error: function (data) {
                    ...
                    submitButton.innerHTML = '<?php echo e(__("Verify Account")); ?>';
                }
            });
        });
...
<?php echo $__env->make('panel.authentication.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Novuk/resources/views/default/panel/authentication/otp_verify.blade.php ENDPATH**/ ?>